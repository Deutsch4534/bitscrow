$(document).ready(function() {
	...
	//$(o).val($("#mediatorPubkey"));

	//$("#multisigPubKeys").ready($("#mediatorPubkey").val());
	
	//$("#multisigPubKeys .pubkey").val("#mediatorPubkey");
	 ...
	 $("#mediatorAddKey").click(function(){
		...
		if(len<3){
			$.each($("#multisigPubKeys .pubkey"),function(i,o){
				count=1;
				if($(o).val()==''){
					$(o).val($("#mediatorPubkey").val()).fadeOut().fadeIn().attr("disabled", "disabled");
					$("#mediatorClose").click();
					return false;
				} else if(count==len){
		...
		if(len<2){
			$.each($("#multisigPubKeys .pubkey"),function(i,o){
				if($(o).val()==''){
					...
					$("#multisigPubKeys .pubkeyAdd").click();
					$("#mediatorAddKey").click();// commented by me
					return false;
				}
				count++;
			});
